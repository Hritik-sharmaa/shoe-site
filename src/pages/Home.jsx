    ...
    <>
      ...
      <div className="home-main container mx-auto">
        <div className="left-main">
          <h1>Find your<br/> Sneaker</h1>
          <p>Our reputations shines as rightly as our shoes. fashionable, 
          quality, durable and best <br/>shoes our will find for everyone.</p>
          <button>Explore more <span><FaArrowRight /></span></button>
        </div>
        <div className="right-main">
          <img src={BannerImg} alt="nike-air-force-2" className="banner-img drop-shadow-2xl"/>
          <div className="tag">100% <br/>comfortable</div>
